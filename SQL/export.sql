...
CREATE TABLE `Contenance` (
  ...
  `cont_quantite` int NOT NULL DEFAULT '1',
  PRIMARY KEY (`id_contenance`),
  UNIQUE KEY `id_equipement` (`id_equipement`,`id_salle`),
...
INSERT INTO `Contenance` VALUES (1,1,1,1),(2,2,1,10),(3,3,2,5),(4,4,2,20),(5,5,3,1),(6,6,4,1),(7,7,5,2),(8,8,6,4),(9,9,7,2),(10,10,8,1),(11,1,9,1),(12,2,10,15),(13,3,11,6),(14,4,12,18),(15,5,13,1),(16,6,14,1),(17,7,15,2),(18,8,16,3),(19,9,17,2),(20,10,18,1),(21,9,21,10),(22,2,22,20),(23,11,1,203);
...
CREATE TABLE `Reservation` (
  ...
  KEY `FK_Reservation_Salle` (`id_salle`),
  KEY `FK_Reservation_Utilisateur` (`id_utilisateur`),
  CONSTRAINT `FK_Reservation_Salle` FOREIGN KEY (`id_salle`) REFERENCES `Salle` (`id_salle`) ON DELETE CASCADE,
...
INSERT INTO `Reservation` VALUES (1,1,1,'2026-02-01','2026-02-03'),(2,2,2,'2026-02-05','2026-02-07'),(3,3,3,'2026-02-10','2026-02-12'),(4,4,4,'2026-02-15','2026-02-18'),(5,5,5,'2026-02-20','2026-02-22'),(6,6,6,'2026-03-01','2026-03-03'),(7,7,7,'2026-03-05','2026-03-07'),(8,8,8,'2026-03-10','2026-03-12'),(9,9,9,'2026-03-15','2026-03-17'),(10,10,10,'2026-03-20','2026-03-22'),(21,1,29,'2026-04-02','2026-04-04'),(36,16,27,'2026-03-01','2026-03-02'),(37,4,27,'2026-03-11','2026-03-12'),(38,1,29,'2026-03-18','2026-03-20'),(39,2,29,'2026-03-06','2026-03-08'),(40,6,29,'2026-03-05','2026-03-09'),(41,2,29,'2026-03-05','2026-03-10'),(42,3,29,'2026-03-04','2026-03-09'),(43,2,29,'2026-03-04','2026-03-06'),(44,3,29,'2026-03-08','2026-03-10');
...
CREATE TABLE `Salle` (
  ...
  `sal_taille` int DEFAULT NULL,
  `sal_numero` varchar(20) DEFAULT NULL,
  `sal_image` varchar(255) DEFAULT NULL,
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2026-02-18 11:05:53',NULL),('diagnostics.include_raw','OFF','2026-02-18 11:05:53',NULL),('ps_thread_trx_info.max_length','65535','2026-02-18 11:05:53',NULL),('statement_performance_analyzer.limit','100','2026-02-18 11:05:53',NULL),('statement_performance_analyzer.view',NULL,'2026-02-18 11:05:53',NULL),('statement_truncate_len','64','2026-02-18 11:05:53',NULL);
...
-- Dump completed on 2026-03-23 20:55:40
